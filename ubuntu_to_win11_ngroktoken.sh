...
clear
echo "Centos Windows 11"
#read -p "Paste authtoken here (Copy and Right-click to paste): " CRP
#./ngrok authtoken $CRP
./ngrok authtoken 1mLGY4J7DGgPqSra9q10z6vfqwV_Ucmg8nU31tEWi8fmFbzk
...
echo Do not close terminal tab. VM expired in 1 hour.